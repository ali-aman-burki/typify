...
from typing import Literal, Union as _TypingUnion
...
def _flatten_union_args(args: tuple[TypeExpr, ...] | list[TypeExpr]) -> tuple[TypeExpr, ...]:
	flat: list[TypeExpr] = []
...
def classify_kind(te_or_str: _TypingUnion[TypeExpr, str]) -> _KIND:
    """
